                    ...
                    <div className="feedbacks-section">
                        ...
                        <div className="feedbacks-poeple">
                            <div className="container-quote">
                                <img className="quote" src="quote.png" id="another-quote" alt="photo"></img>
                            </div>
                        ...
                        <div className="feedbacks-poeple">
                            <div className="container-quote">
                                <img className="quote" src="quote.png" id="left-top" alt="photo"></img>
                            </div>
                            <div className="feedbacks-msg">
                        ...
                        <div className="feedbacks-poeple">
                            <div className="container-quote">
                                <img className="quote" src="quote.png" id="right-bottom" alt="photo"></img>
                            </div>
                            <div className="feedbacks-msg">
                        ...
                        <div className="feedbacks-poeple">
                            <div className="container-quote">
                                <img className="quote" src="quote.png" id="left-bottom" alt="photo"></img>
                            </div>
                            <div className="feedbacks-msg">
