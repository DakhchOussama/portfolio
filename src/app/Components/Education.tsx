            ...
            <div className="education" id="test">
                <div className="education-container">
                    <div className="education-header">
                        <h1>Education</h1>
                        <p>Since I started my education in 2017 after completing my baccalaureate, the passing years have been a broad canvas of experiences. Beyond the world of academics, I've explored the details of life, gaining valuable insights and refining my survival skills. This prolonged period of learning has not only developed my skills in programming but has also been a journey of personal and professional development.</p>
                    </div>
